...
do
  ...
  if [ ! -f "19AE1-4-A_fep.gro" ] || [ ! -f "19AE1-4-A_fep.top" ] || [ ! -f "prod_fep.mdp" ]|| [ ! -f "index.ndx" ]; then
  ...
  gmx grompp -f prod_fep.mdp -c 19AE1-4-A_fep.gro -p 19AE1-4-A_fep.top -n index.ndx -o HREMD.tpr
